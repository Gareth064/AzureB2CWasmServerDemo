...
public class AuthorizationController : ControllerBase
{
    ...
    [HttpGet]
    [Route("GetWorkspaceByUserId/{azureUserId}")]
    ...
    private void PopulateWorkspaces()
    {
        ...
        workspaces.Add(new Workspace { Id="1234", Name="My Shop", HasValidSubscription=false, Owner="2bba57e9-85d8-4f8b-b7d4-a401e96c4171" });
